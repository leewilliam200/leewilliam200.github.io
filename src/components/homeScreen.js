    ...
    return (
        <div className="main">
            ...
            <div id="about" className={`aboutCont ${isAboutVisible ? 'is-visible' : ''}`} ref={aboutRef}>
                ...
                <br></br>
                <p3>
                    During my time at UNSW, I was
                    <p3 className="highlight"> selected </p3>
                    for the UNSW DESN2000 pitch
                    showcase in 2020 with a prototype public transport application and I was <p3 className="highlight"> nominated </p3> for the UNSW
                    SENG3011
                    Optiver Prize in 2021 for an epidemiology web application.
                </p3>
                <br></br>
                <p3>
                    Feel free to explore my portfolio to see the projects I've worked on and the skills I've developed. Enjoy your stay and I hope
                    you'll learn at least a little bit more about me!
                </p3>
            </div>
            ...
            <div id="project" className={`projectCont ${isProjectVisible ? 'is-visible' : ''}`} ref={projectRef}>
                <div className='projectDesc'>
                    <p1>My Projects</p1>
                    <br></br>
                    <p3>Here are some of the projects that I've developed over the years and what skills I have obtained in my short history of coding
                        so far. You can click on
                        each card to see more information about the project and what skills I had developed.
                    </p3>
                    <br></br><br></br>
                </div>
                <div className="projectInfoContainer">
                    <div className='project' onClick={handleWordleBot}>
                        ...
                        <p3 className="projectInfo">A <p3 className="highlightCard"> machine learning </p3> algorithm implemented using
                            <p3 className="highlightCard"> Pytorch </p3> on a Wordle replica created in <p3 className="highlightCard"> Pygame.</p3>
                        </p3>
                    </div>
                    <div className='project' onClick={handleProdiff}>
                        ...
                        <p3 className="projectInfo">A <p3 className="highlightCard"> web analytics </p3> tool utilising the <p3
                            className="highlightCard"> Riot API </p3>
                            where players can compare in-game stats with each other and in particular, professional players
                        </p3>
                    </div>
                    <div className='project' onClick={handlePromed}>
                        ...
                        <p3 className="projectInfo">A <p3 className="highlightCard"> web application </p3> that displays disease reports and recent
                            social
                            media posts for chosen diseases which sends a <p3 className="highlightCard"> daily </p3> email with any recent updates.
                        </p3>
                    </div>
                    <div className='project' onClick={handleTransportme}>
                        ...
                        <p3 className="projectInfo">A prototype <p3 className="highlightCard"> public transport scheduling </p3> application where
                            ...
                            <p3 className="highlightCard"> live </p3> traffic information.
                        </p3>
                    </div>
                </div>
            </div>
            ...
            <div id="contact" className={`contactCont ${isContactVisible ? 'is-visible' : ''}`} ref={contactRef}>
                ...
                <p3>If you have any reason to contact me, you can email me at <a href="mailto:leewilliam200@gmail.com">leewilliam200@gmail.com</a>.
                    Reach out to me and I'll be sure to respond to you as soon as possible. Even if it's just questions about projects I've developed
                    in the past
